...
#include <iomanip>
#include <string>
#include "5.30-33 Enhance class DollarAmount (Fig. 5.8).h"
using namespace std;

int main() {
   DollarAmount d1{15, 150}; // $123.45
   DollarAmount d2{10, 50}; // $15.76
   ...
   DollarAmount balance{10000}; // initial principal amount in pennies
   ...
   for (unsigned int year{1}; year <= 10; year++) {
      ...
      DollarAmount test{10, 0}; // 10$
      cout << "Befor divide: " << test.toString() << endl;

      test.divide(3);
      cout << "After divide by 3: " << test.toString() << endl;
}
